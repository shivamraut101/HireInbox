...
function __VLS_template() {
    ...
    var __VLS_5;
    ['min-h-[80vh]', 'flex', 'items-center', 'justify-center', 'card', 'w-full', 'max-w-md', 'text-2xl', 'font-bold', 'mb-6', 'text-center', 'mb-6', 'flex', 'rounded-md', 'shadow-sm', 'flex-1', 'px-4', 'py-2', 'text-sm', 'rounded-l-md', 'flex-1', 'px-4', 'py-2', 'text-sm', 'rounded-r-md', 'space-y-4', 'block', 'text-sm', 'font-medium', 'mb-1', 'w-full', 'rounded-md', 'border-gray-300', 'dark:bg-gray-700', 'dark:border-gray-600', 'block', 'text-sm', 'font-medium', 'mb-1', 'w-full', 'rounded-md', 'border-gray-300', 'dark:bg-gray-700', 'dark:border-gray-600', 'w-full', 'btn-primary', 'mt-4', 'text-center', 'text-sm', 'text-gray-600', 'dark:text-gray-400', 'text-primary-600', 'hover:text-primary-500',];
    var __VLS_slots;
    var $slots;
